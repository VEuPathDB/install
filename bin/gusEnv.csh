...
setenv PROJECT_HOME $PWD/project_home
setenv GUS_HOME $PWD/gus_home
setenv PATH $PRE_GUS_PATH/:$PROJECT_HOME/install/bin:$GUS_HOME/bin:$POST_GUS_PATH
set pwd = `basename $PWD` ; set prompt="[%m:$pwd %c]$ "
